...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        default_model = 'stacking_ensemble.joblib'
        ...
        print(f"Example: python predict/predict_model.py stacking_ensemble")
        print(f"         python predict/predict_model.py models/stacking_ensemble.joblib")
        print()
